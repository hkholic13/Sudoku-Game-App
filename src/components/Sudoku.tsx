...
const style: Record<string, CSSProperties> = {
  ...
  btn: { backgroundColor: "#0000", fontWeight: "bold", border: "none", borderRadius: 5, padding: 8 },
  cellControl: {
    position: "absolute", 
    top: 0, 
    bottom: 0, 
  ...
  reveals: { padding: 8, border: "1px solid #000", borderRadius: "0 5px 5px 0", borderLeft: "none" },
